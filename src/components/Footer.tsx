        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-2">
            <h3 className="text-3xl font-bold mb-4">
              JEG<span className="text-blue-400">Health</span>
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#api" className="text-gray-300 hover:text-blue-400 transition-colors">API Documentation</a></li>
        ...
        <div className="border-t border-gray-700 pt-8 mt-12">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <a href="#compliance" className="text-gray-400 hover:text-blue-400 transition-colors">HIPAA Compliance</a>
            </div>
          </div>
        </div>
      </div>
