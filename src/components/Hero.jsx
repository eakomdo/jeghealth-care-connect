  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-32 left-1/4 w-40 h-40 border border-blue-200 rounded-full"></div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-4">
              JEG<span className="text-blue-600">Health</span>
            </h1>
          ...
          <h2 className="text-3xl md:text-4xl font-semibold text-gray-800 mb-6 leading-tight">
            ...
            <br />
            <span className="text-blue-600">For Healthcare Excellence</span>
          </h2>
